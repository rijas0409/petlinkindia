import { Search, Bell, LayoutGrid, LogOut } from "lucide-react";
...
const AdminTopBar = ({ user, onLogout }: AdminTopBarProps) => {
    ...
    <header className="sticky top-0 z-40 bg-white/80 backdrop-blur-lg border-b border-[hsl(220,20%,92%)]">
      <div className="flex items-center justify-between px-8 py-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="h-8 w-px bg-[hsl(220,20%,90%)]" />

          <div className="flex items-center gap-3">
            <div className="text-right">
              <p className="text-sm font-semibold text-[hsl(220,20%,15%)]">
            ...
            <button
              onClick={onLogout}
              className="w-10 h-10 rounded-full bg-[hsl(220,20%,94%)] flex items-center justify-center text-[hsl(220,15%,45%)] hover:bg-[hsl(220,20%,90%)] transition-colors"
              title="Logout"
            >
