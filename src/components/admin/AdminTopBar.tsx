import { Search, Bell, LayoutGrid, LogOut, Menu, User, Settings } from "lucide-react";
          ...
          <div className="relative" ref={dropdownRef}>
            <div className="flex items-center gap-2 md:gap-3">
              ...
              <button
                ...
                className="w-10 h-10 rounded-full bg-gradient-to-br from-[hsl(220,80%,55%)] to-[hsl(250,70%,55%)] flex items-center justify-center text-white font-bold text-sm shadow-md hover:shadow-lg transition-all"
              >
                {initial}
              </button>
            </div>
            ...
            {profileOpen && (
              <div className="absolute right-0 top-[calc(100%+8px)] w-56 bg-white rounded-2xl shadow-xl border border-[hsl(220,20%,92%)] overflow-hidden z-50 animate-in fade-in slide-in-from-top-2 duration-200">
                {/* User Info */}
                <div className="px-4 py-3 border-b border-[hsl(220,20%,94%)] bg-[hsl(220,20%,98%)]">
